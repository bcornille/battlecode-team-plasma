    ...
    static void run(RobotController rc) throws GameActionException {
        ...
        while (true) { 
        	...
        	try {
            	...
            	dir = MovementScout.scoutSpiralRight(dir);
            	
            	System.out.println(rc.readBroadcast(CHANNEL_MAP_XMIN) + ", " + 
            					   rc.readBroadcast(CHANNEL_MAP_XMAX) + ", " + 
            			           rc.readBroadcast(CHANNEL_MAP_YMIN) + ", " + 
            					   rc.readBroadcast(CHANNEL_MAP_YMAX));
